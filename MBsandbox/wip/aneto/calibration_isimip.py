...
r00=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r00=r00.mean(axis=1)
...
r01=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r01=r01.mean(axis=1)
ensamble_name=ensamble_names[0]

ssp=ssps[2]

r02=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r02=r02.mean(axis=1)
ensamble_name=ensamble_names[1]

ssp=ssps[0]

r10=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r10=r10.mean(axis=1)
ensamble_name=ensamble_names[1]

ssp=ssps[1]

r11=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r11=r11.mean(axis=1)
ensamble_name=ensamble_names[1]

ssp=ssps[2]

r12=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r12=r12.mean(axis=1)
ensamble_name=ensamble_names[2]

ssp=ssps[0]

r20=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r20=r20.mean(axis=1)
ensamble_name=ensamble_names[2]

ssp=ssps[1]

r21=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r21=r21.mean(axis=1)
ensamble_name=ensamble_names[2]

ssp=ssps[2]

r22=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r22=r22.mean(axis=1)
ensamble_name=ensamble_names[3]

ssp=ssps[0]

r30=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r30=r30.mean(axis=1)
ensamble_name=ensamble_names[3]

ssp=ssps[1]

r31=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r31=r31.mean(axis=1)
ensamble_name=ensamble_names[3]

ssp=ssps[2]

r32=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r32=r32.mean(axis=1)
ensamble_name=ensamble_names[4]

ssp=ssps[0]

r40=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r40=r40.mean(axis=1)
ensamble_name=ensamble_names[4]

ssp=ssps[1]

r41=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r41=r41.mean(axis=1)
ensamble_name=ensamble_names[4]

ssp=ssps[2]

r42=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/{ensamble_name}_{ssp}_yearly_mb.pkl')
r42=r42.mean(axis=1)

calib=pd.read_pickle(f'{out_path}/{n}x{n}_850/calibration/w5e5__yearly_mb.pkl')
...
plt.savefig(f'{out_path}/{n}x{n}/calibration/all_yearly_mb')
plt.show()
