...
fig.show()  
plt.savefig(f'{out_path}/{n}x{n}/{cal}_{ssp}/{ensamble_name}_melt_f_0_{y_alfa}-{y_omega}+2')
plt.show()

aaa = in_data[2]

aaa.to_netcdf(f'{out_path}/{n}x{n}/{cal}_{ssp}/{ensamble_name}_melt_f_0_{y_alfa}-{y_omega}+2.nc')
