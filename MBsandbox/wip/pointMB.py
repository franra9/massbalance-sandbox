...
from oggm.utils import (date_to_floatyear, floatyear_to_date, clip_array, clip_min)
...
#     #assert heights[0] > 0, 'only positive altitudes make sense!'#heights[-1], "heights should be in descending order!"
